...
#include <math.h>
#include <time.h>
#define m 6 // The number of receivers
#define n 6 // The number of packets
#define u 10
...
int main()
{
	...
	int count = 0;
	int N = 0;
	float e = 0.05; /* The error probability that the Transmitter sends a packet to each receiver.*/
